...
export const mockDataTeam = [
  {
    ...
    address1: "123 Winterfell Street",
    address2: "North District",
    isDeleted: false,
    createdAt: "2024-01-01T00:00:00Z",
    updatedAt: "2024-01-01T00:00:00Z",
    lastLoginAt: "2024-07-23T00:00:00Z",
    isActive: true,
    avatarUrl: "",
    roles: [
      { id: 3, name: "store_manager", label: "门店经理", description: "管理门店日常运营" }
    ],
    directPermissions: [],
    permissions: []
  },
  {
    ...
    address1: "456 Red Keep Avenue",
    address2: "King's Landing",
    isDeleted: false,
    createdAt: "2024-01-02T00:00:00Z",
    updatedAt: "2024-01-02T00:00:00Z",
    lastLoginAt: "2024-07-22T00:00:00Z",
    isActive: true,
    avatarUrl: "",
    roles: [
      { id: 7, name: "sales_staff", label: "销售人员", description: "负责销售业务" }
    ],
    directPermissions: [],
    permissions: []
  },
  {
    ...
    address1: "789 Gold Road",
    address2: "Casterly Rock",
    isDeleted: false,
    createdAt: "2024-01-03T00:00:00Z",
    updatedAt: "2024-01-03T00:00:00Z",
    lastLoginAt: "2024-07-21T00:00:00Z",
    isActive: true,
    avatarUrl: "",
    roles: [
      { id: 10, name: "viewer", label: "访问者", description: "只读权限" }
    ],
    directPermissions: [],
    permissions: []
  },
  {
    ...
    firstName: "Anya",
    lastName: "Stark",
    email: "anya.stark@gmail.com",
    contact: "(921)425-6742",
    address1: "1111 Needle Lane",
    address2: "Winterfell",
    isDeleted: false,
    createdAt: "2024-01-04T00:00:00Z",
    updatedAt: "2024-01-04T00:00:00Z",
    lastLoginAt: "2024-07-20T00:00:00Z",
    isActive: true,
    avatarUrl: "",
    roles: [
      { id: 8, name: "warehouse_staff", label: "仓库人员", description: "管理仓库操作" }
    ],
    directPermissions: [],
    permissions: []
  },
  {
    ...
    address1: "2222 Dragonstone",
    address2: "Bay of Dragons",
    isDeleted: false,
    ...
    avatarUrl: "",
    roles: [
      { id: 2, name: "regional_manager", label: "区域经理", description: "管理区域业务" }
    ],
    directPermissions: [],
    permissions: []
  },
  {
    ...
    address1: "3333 Cellar Street",
    address2: "King's Landing",
    isDeleted: false,
    createdAt: "2024-01-06T00:00:00Z",
    updatedAt: "2024-01-06T00:00:00Z",
    lastLoginAt: "2024-07-19T00:00:00Z",
    isActive: true,
    avatarUrl: "",
    roles: [
      { id: 9, name: "financial_staff", label: "财务人员", description: "处理财务事务" }
    ],
    directPermissions: [],
    permissions: []
  },
  {
    ...
    avatarUrl: "",
    roles: [
      { id: 4, name: "sales_manager", label: "销售经理", description: "管理销售团队" }
    ],
    directPermissions: [],
    permissions: []
  },
  {
    ...
    address1: "5555 Three-Eyed Avenue",
    address2: "Winterfell",
    isDeleted: false,
    createdAt: "2024-01-08T00:00:00Z",
    updatedAt: "2024-01-08T00:00:00Z",
    lastLoginAt: "2024-07-18T00:00:00Z",
    isActive: false,
    avatarUrl: "",
    roles: [
      { id: 5, name: "inventory_manager", label: "库存经理", description: "管理库存系统" },
      { id: 10, name: "viewer", label: "访问者", description: "只读权限" }
    ],
    directPermissions: [],
    permissions: []
