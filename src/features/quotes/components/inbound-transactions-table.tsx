...
export function InboundTransactionsTable() {
  ...
  const getStatusColor = (status: string | null | undefined): BadgeVariant => {
            ...
            {paginatedTransactions.length === 0 ? (
              ...
              paginatedTransactions.map((transaction) => (
                <TableRow key={transaction.id}>
                  ...
                  <TableCell>{transaction.itemCount || 0}</TableCell>
                  <TableCell>
                    <Badge variant={getStatusColor(transaction.status)}>{transaction.status || "unknown"}</Badge>
                  </TableCell>
                  <TableCell>
