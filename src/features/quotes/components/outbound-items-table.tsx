...
import type { OutboundItem } from "@/lib/types"
import type { ReactNode } from "react"

interface OutboundItemsTableProps {
  items: OutboundItem[]
  updateItem: (id: string, field: keyof OutboundItem, value: any) => void
  removeItem: (id: string) => void
  renderItemBadge?: (item: OutboundItem) => ReactNode
}

export function OutboundItemsTable({ items, updateItem, removeItem, renderItemBadge }: OutboundItemsTableProps) {
  return (
